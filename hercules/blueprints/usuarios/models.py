...
class Usuario(database.Model, UserMixin, UniversalMixin):
    ...
    ofi_documentos_comentarios: Mapped[List["OfiDocumentoComentario"]] = relationship("OfiDocumentoComentario", back_populates="usuario")
    ofi_documentos_flujos: Mapped[List["OfiDocumentoFlujo"]] = relationship("OfiDocumentoFlujo", back_populates="usuario")
