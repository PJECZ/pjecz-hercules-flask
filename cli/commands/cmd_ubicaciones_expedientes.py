...
def actualizar(autoridad_clave):
    ...
    arc_documentos = ArcDocumento.query.filter_by(autoridad_id=autoridad.id).filter_by(estatus="A")
    ...
    for arc_documento in arc_documentos.all():
        ...
        # Si existe, actualizarlo en caso de ubicación sea diferente
